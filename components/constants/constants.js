...
export const projects = [
    ...
    },
    {
      name: "MyWebClass",
      description:
        "A marketing website using Next.js containing blogs and a sales funnel implementation for a brand archetype. Implemented unit testing to the project using playwright and lighthouse. Configured continuous integration and continuous deployment to the project using GitHub Actions. Added search engine optimizations and integrated google analytics to the website.",
      tags: [
        {
          name: "nextjs",
          color: "badge-info",
